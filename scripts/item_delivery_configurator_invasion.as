...
class ItemDeliveryConfiguratorInvasion : ItemDeliveryConfigurator {
	...
	protected void setupGift3() {
		...
		array<array<ScoredResource@>> rewardPasses = {
			{
				ScoredResource("g11_9", "carry_item", 30.0f),
				ScoredResource("m14_303", "carry_item", 30.0f),
				ScoredResource("m99_1701", "carry_item", 30.0f),
				ScoredResource("m1873_301", "carry_item", 30.0f),
				ScoredResource("ump45_410", "carry_item", 30.0f),
				ScoredResource("ump9_409", "carry_item", 30.0f),
				ScoredResource("gift_box_community_1.carry_item", "carry_item", 30.0f)     
			},
			{
				ScoredResource("g11_9", "carry_item", 30.0f),
				ScoredResource("m14_303", "carry_item", 30.0f),
				...
				ScoredResource("ump45_410", "carry_item", 30.0f),
				ScoredResource("ump9_409", "carry_item", 30.0f),
				ScoredResource("gift_box_community_2.carry_item", "carry_item", 30.0f)    
			}
		};  
		...
		array<array<ScoredResource@>> rewardPasses = {
			{
				...
				ScoredResource("gift_box_community_2.carry_item", "carry_item", 10.0f),        
			...
			},
			{
         		...
         		ScoredResource("costume_underpants.carry_item", "carry_item", 25.0f),
		...
		array<array<ScoredResource@>> rewardPasses = {
			{
				...
				ScoredResource("gift_box_community_1.carry_item", "carry_item", 10.0f),
