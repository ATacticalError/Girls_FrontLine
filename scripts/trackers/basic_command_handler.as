...
class BasicCommandHandler : Tracker {
	...
	protected void handleChatEvent(const XmlElement@ event) {
		...
		} else if (checkCommand(message, "create_vehicle")) {spawnInstanceNearPlayer(senderId, "special_cargo_vehicle1.vehicle", "vehicle");
		} else if (checkCommand(message, "ma")) 			{spawnInstanceNearPlayer(senderId, "mobile_armory.vehicle", "vehicle");
		} else if (checkCommand(message, "jeep")) 			{spawnInstanceNearPlayer(senderId, "jeep.vehicle", "vehicle");
		} else  if(checkCommand(message, "suitcase")) 		{spawnInstanceNearPlayer(senderId, "suitcase.carry_item", "carry_item");
		} else  if(checkCommand(message, "laptop")) 		{spawnInstanceNearPlayer(senderId, "laptop.carry_item", "carry_item");      
		} else  if(checkCommand(message, "c4")) 			{spawnInstanceNearPlayer(senderId, "c4.projectile", "projectile");      
		} else if (checkCommand(message, "dc")) 			{spawnInstanceNearPlayer(senderId, "cover_resource.weapon", "weapon");
		} else if (checkCommand(message, "dgl")) 			{spawnInstanceNearPlayer(senderId, "gl_resource.weapon", "weapon");
		} else if (checkCommand(message, "dmg")) 			{spawnInstanceNearPlayer(senderId, "mg_resource.weapon", "weapon");
		} else if (checkCommand(message, "dminig")) 		{spawnInstanceNearPlayer(senderId, "minig_resource.weapon", "weapon");
		...
		} else  if(checkCommand(message, "darkcat")) {
			spawnInstanceNearPlayer(senderId, "tank2.vehicle", "vehicle", 0);   
